...
public class LoggingAspect {
  ...
  @Pointcut(
      "within(io.github.bhuwanupadhyay.rtms.order.application..*)"
          + " || within(io.github.bhuwanupadhyay.rtms.order.infrastructure..*)"
          + " || within(io.github.bhuwanupadhyay.rtms.order.interfaces..*)")
