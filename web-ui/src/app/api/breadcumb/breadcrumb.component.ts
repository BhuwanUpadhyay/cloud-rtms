...
export class BreadcrumbComponent implements OnInit {
  ...
  buildBreadCrumb(route: ActivatedRoute, url: string = '', breadcrumbs: Breadcrumb[] = []): Breadcrumb[] {
    ...
    let bLabel = route.routeConfig && route.routeConfig.data ? route.routeConfig.data.breadcrumb : '';
    ...
    if (isDynamicRoute && !!route.snapshot) {
      ...
      bLabel = route.snapshot.params[paramName];
    }
    ...
    // Only adding route with non-empty l
